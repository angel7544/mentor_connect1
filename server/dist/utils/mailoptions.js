...
exports.supportContactOpition = exports.Subscriptions = exports.welcomeMailOptions = void 0;
// Register   mail 
...
const supportContactOpition = (firstName, email, subject, message) => {
    // Get the current date and time
    const now = new Date();
    const options = {
        weekday: 'long',
...
exports.supportContactOpition = supportContactOpition;
